module.exports = {
    ...
    _init: function () {
        if ( ! this.options.Vue.prototype.$router) {
    ...
    _beforeEach: function (routerBeforeEach, transitionEach) {
        ...
        this.options.Vue.prototype.$router.beforeEach(function (transition, location, next) {
    ...
    _routerReplace: function (data) {
        var router = this.options.Vue.prototype.$router;
